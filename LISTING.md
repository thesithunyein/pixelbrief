...
Endpoint base: https://pixelbrief.tech
Services:
...
## Icon / avatar notes
- Upload `public/brand/app-icon.png` (same as `logo-mark.png`) as the OKX.AI avatar
- Do not regenerate the mark — use the locked PNG in `public/brand/logo-mark.png`
